...
public final class JavassistTypeParameterMatcherGenerator {
    ...
    public static TypeParameterMatcher generate(Class<?> type, ClassLoader classLoader) {
        ...
        try {
            ...
            ClassLoader methodClassloader = type.getClassLoader() != null ? type.getClassLoader() : classLoader;
            Class<?> generated = (Class<?>) method.invoke(methodClassloader, className, byteCode, 0, byteCode.length);
